...
from model.vegetationPredictor import (  # noqa: E402
    LearnedForestMasker, _per_pixel_features, _LEARNED_FEATURE_KEYS,
)

# Post-period analogue of _LEARNED_FEATURE_KEYS.
_POST_FEATURE_KEYS: tuple[str, ...] = (
    ...
    "s1_post_vv_median",   "s1_post_vv_std",
)
...
def main():
    ...
    post_masker = LearnedForestMasker(backend="lightgbm").fit(post_views, seed=args.seed)
